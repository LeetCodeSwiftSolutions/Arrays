...
/// Beats 100% in Runtime & 50% in Memory.
///
func fizzBuzz(_ n: Int) -> [String] {
    var answer = [String](repeating: "", count: n)
    for num in 1...n {
        if num % 15 == 0 { answer[num-1] = "FizzBuzz" }
        else if num % 5 == 0 { answer[num-1] = "Buzz" }
        else if num % 3 == 0 { answer[num-1] = "Fizz" }
        else { answer[num-1] = String(num) }
    }
    return answer
}
